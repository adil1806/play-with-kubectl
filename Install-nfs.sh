...
## Info
echo -n "[TASK 1] Installing all updates, this may take a few minutes ...";
apt-get update -y >/dev/null 2>&1

## Install NFS
echo -n "[TASK 2] Installing NFS ...";
apt-get install nfs-kernel-server -y >/dev/null 2>&1


## NFS Folders
echo -n "[TASK 3] Creating/Adjusting Folder /nfs-demo and editing /etc/exports ...";
...
## Restart Services
echo -n "[TASK 4] Restarting Services ...";
